...
export const ApiErrorCode = {
  ...
  SOFTWARE_BLACKLISTED: 'SOFTWARE_BLACKLISTED',
...
const ERROR_MESSAGES: Readonly<Record<ApiErrorCode, string>> = {
  ...
  DRAFT_EXPIRED: 'The draft was cleared after being idle; start a new application',
  ...
  AI_INPUT_INVALID: 'The answers do not contain enough meaningful information',
  ...
  SOFTWARE_BLACKLISTED: 'The declared software or vendor is not eligible for this program',
