...
export function PassportHistory({ caseId }: { caseId: string }) {
  ...
  return <section aria-labelledby="passport-history-title"><h2 id="passport-history-title">資料流向版本紀錄</h2>{versions.length === 0 ? <p>尚無可顯示的版本紀錄。</p> : <ol>{versions.map((version) => <li key={version.id}><strong>第 {version.versionNo} 版</strong> · {version.workflowState} · {version.origin} · <time dateTime={version.createdAt}>{version.createdAt}</time></li>)}</ol>}</section>;
}
