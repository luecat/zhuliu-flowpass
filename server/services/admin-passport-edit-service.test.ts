...
describe('admin passport field editor', () => {
  ...
  beforeEach(() => {
    ...
    const details = JSON.stringify({ billingCycle: 'annual', billingPeriods: null, softwareFunction: 'general', otherFunction: null, softwareName: 'Photo Pro', companyName: '竹流', purchaseDate: '2026-09-01', payerType: 'self_card', originalCurrency: 'TWD', otherCurrency: null, originalExpense: '1000', convertedTwd: 1000, specialStatus: false, invoiceNumber: null, paymentSourceFingerprint: null, subscriptionStartDate: '2026-08-01', subscriptionEndDate: '2027-07-31', applicantName: '測試申請人' });
