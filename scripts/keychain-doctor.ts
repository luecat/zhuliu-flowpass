...
export const LOGICAL_SECRETS = ['line-channel-access-token', 'line-channel-secret', 'line-login-channel-secret', 'lm-studio-api-token', 'vault-master-key-v1', 'flowpass-master-key', 'session-hmac-key-v1', 'backup-master-key-v1'] as const;
